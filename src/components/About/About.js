...
export default function About() {
  return (
    <div className="about">
      <h2>About Me</h2>
      <p>
        I'm an aspiring software engineer working on improving my skills and
        making small projects. I made this page to practice working with apis
        and building react apps from scratch.
      </p>
      <p>
